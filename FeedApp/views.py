...
def friends(request):
    ...
    if not user_relationships.exists():
        ...
        #relationship= Relationship.objects.filter(sneder=user_profile,status='sent')
    ...
    if request.method== 'POST' and request.POST.get('send_requests'):
        ...
        return redirect('FeedApp:freinds')
    ...
    if request.method =='POST' and request.POST.get('receive_requests'):
        ...
        for sender in senders:
            ...
            user_profile.freinds.add(relationship_obj.sender.user)
